...
class WdlV1ParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by WdlV1Parser#comment.
    def visitComment(self, ctx:WdlV1Parser.CommentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by WdlV1Parser#meta_comment.
    def visitMeta_comment(self, ctx:WdlV1Parser.Meta_commentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by WdlV1Parser#meta_value_comment.
    def visitMeta_value_comment(self, ctx:WdlV1Parser.Meta_value_commentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by WdlV1Parser#meta_array_comment.
    def visitMeta_array_comment(self, ctx:WdlV1Parser.Meta_array_commentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by WdlV1Parser#meta_object_comment.
    def visitMeta_object_comment(self, ctx:WdlV1Parser.Meta_object_commentContext):
        return self.visitChildren(ctx)
